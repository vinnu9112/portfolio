  ...
  return (
    <div id='services'>
        ...
        <div className="b-container">
            ...
            <Box image={image2} title='To Do List' text='An static React app which can help you list down your new or incomplete tasks and can be used a tool for time management and organization.' link='https://vinnu9112.github.io/to-do-list/' alt='image2' button='Visit Site'/>
